...
const HELP_ROWS: HelpRow[] = [
  ...
  { kind: "binding", keys: "Alt+← / →", description: "Move between the three panes" },
  {
    kind: "binding",
    keys: "Alt+↑ / ↓",
  ...
  { kind: "binding", keys: "Alt+T", description: "New tmux window in this session" },
  {
    kind: "binding",
    keys: "Alt+W",
    description: "Close this window; the last one ends the session",
  },
  { kind: "binding", keys: "Alt+[ / ]", description: "Previous / next tmux window" },
